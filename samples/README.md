...
The integration tests in `tests/test_samples.py` run against every `*.dxf` in this
...
The layer names are configurable in the profile (`floor.boundary_layer`, `floor.origin_layer`).
